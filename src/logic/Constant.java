...
class Constants {
    ...
    public static final int TANK_SPEED = 2,
            TANK_ROTATION_SPEED = 2; //means 2 degree
    public static final int BULLET_POWER = 20, BULLET_SPEED = 3;
    public static final int WALL_HEIGHT_HORIZONTAL = 50, WALL_WIDTH_HORIZONTAL = 150, WALL_HEIGHT_VERTICAL = 150, WALL_WIDTH_VERTICAL = 50;
    ...
    public static final int LOOLE_TANK_SIZE = 40;
